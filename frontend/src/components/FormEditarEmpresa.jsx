...
FormEditarEmpresa.propTypes = {
  formData: PropTypes.shape({
    ...
    telefoneJuridico: PropTypes.string,
    enderecoJuridico: PropTypes.string,
    estadoJuridico: PropTypes.string,
    areaAtuacao: PropTypes.string,
  }).isRequired,
