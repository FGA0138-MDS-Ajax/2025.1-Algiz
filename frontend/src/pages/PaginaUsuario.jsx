...
export default function PaginaUsuario() {
  ...
  // === Helper to fetch with refresh token fallback ===
      ...
      <div className="container mx-auto flex flex-col lg:flex-row gap-6 max-w-6xl mt-8">
        ...
        <aside className="w-full lg:w-80 mt-6 lg:mt-0">
          <Link
            ...
            className="flex items-center rounded-xl px-6 py-4 gap-2 mb-8 shadow font-medium text-gray-700 bg-white hover:bg-green-50 transition"
          >
            <svg width="22" height="24" viewBox="0 0 22 24" fill="none"> {/* (SVG remains unchanged) */} </svg>
